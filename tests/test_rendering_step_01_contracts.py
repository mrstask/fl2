...
class TestRenderingStep01Contracts(unittest.TestCase):
    def test_step_01_has_required_tasks_and_quality_gates(self) -> None:
        expectation = StepExpectation(
            step="1",
            task_ids=("RND-01-01", "RND-01-02", "RND-01-03", "RND-01-04"),
        )
